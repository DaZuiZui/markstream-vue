...
Partial input stays renderable.
  ...
  },
  {
    ...
    category: 'infra',
    description: 'Renders a single AST node through an explicit component map; the building block for nested and custom node rendering.',
    descriptionZh: '按显式组件映射渲染单个 AST 节点，是嵌套与自定义节点渲染的基础构件。',
    mdSnippet: '',
    peers: [],
    heavy: false,
    tags: ['api'],
  ...
  },
  {
    ...
    category: 'infra',
    description: 'Fast-path renderer for arrays of simple inline nodes (text, emphasis, links, and friends) without mounting the full block renderer.',
    descriptionZh: '简单行内节点数组（文本、强调、链接等）的快速渲染路径，无需挂载完整块渲染器。',
    mdSnippet: '',
    peers: [],
    heavy: false,
    tags: ['api', 'inline'],
