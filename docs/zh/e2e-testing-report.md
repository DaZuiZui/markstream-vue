...
- 新页面：`/zh/guide/e2e-testing-report`

如果你的链接仍指向 `/zh/e2e-testing-report`，页面将自动跳转。

<script>
  if (typeof window !== 'undefined') {
    window.location.replace('/zh/guide/e2e-testing-report')
  }
</script>

<noscript>
  页面已迁移：请访问 <a href="/zh/guide/e2e-testing-report">中文指南 – E2E 测试报告</a>
</noscript>
# E2E 测试报告（中文）

> 英文版参见：`docs/e2e-testing-report.md`。
